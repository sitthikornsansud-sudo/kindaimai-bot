...
OCRSPACE_API_KEY = os.environ.get("OCRSPACE_API_KEY", "")  # OCR สำรอง ฟรี ไม่ต้องผูกบัตร
...
def ocr_image(image_bytes: bytes) -> str:
    """ลอง Google ก่อน (แม่นสุดกับภาษาไทย) ถ้าใช้ไม่ได้สลับไป OCR.space อัตโนมัติ"""
    if GOOGLE_VISION_API_KEY:
        try:
            ...
            print("Google OCR ใช้ไม่ได้ สลับไปตัวสำรอง:", e)
    if OCRSPACE_API_KEY:
        try:
